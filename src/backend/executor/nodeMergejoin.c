		...
		switch (node->mj_JoinState)
		{
...
#if DASOM_LOG
				/* DASOM : 15th Oct, 2015*/
				fprintf(stderr, "EXEC_MJ_INITIALIZE_OUTER\n");
#endif
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "OUTER_MATCHABLE\n");
#endif
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "OUTER_NON_MATCHABLE_Fetch next outer tuple\n");
#endif
...
#if DASOM_LOG
				/* DASOM : 15th Oct, 2015*/
				fprintf(stderr, "ExecMergeJoin: EXEC_MJ_INITIALIZE_INNER\n");
#endif
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "INNER_MATCHABLE!_done_init tuples\n");
#endif
						/*
...
#if DASOM_LOG					
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "INNER_NON MATCHABLE!_fetch_next inner tuple\n");
#endif
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "Nothing in inner subplan\n");
#endif
...
#if DASOM_LOG
				/* DASOM : 15th Oct, 2015*/
				fprintf(stderr, "EXEC_MJ_JOINTUPLES\n");
#endif
...
#if DASOM_LOG	
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "returning tuple\n");
#endif
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_Match_newInner\n");
#endif
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "no more inner tuples\n");
#endif
						/*
...
#if DASOM_LOG					
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_end_of_outer\n");
#endif			
						innerTupleSlot = node->mj_InnerTupleSlot;
			...
			case EXEC_MJ_SKIP_TEST:
...
#if DASOM_LOG
					/* DASOM : 15th Oct, 2015*/
					fprintf(stderr, "unable to join_ skip outer adv\n");
#endif
				}
#endif
				...
				else
				{
					...
					node->mj_JoinState = EXEC_MJ_SKIPINNER_ADVANCE;
					/* DASOM : 15th Oct, 2015*/
					//fprintf(stderr, "unable to join_skip inner adv\n");
				}
#endif
				break;
...
#if DASOM_LOG
				/* DASOM : 15th Oct, 2015*/
				fprintf(stderr, "EXEC_skipouter_adv\n");
#endif
				if (doFillOuter && !node->mj_MatchedOuter)
				{
					/*
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_outer matchable\n");
#endif
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_outer unmatchable\n");
#endif
						/* Can't match, so fetch next outer tuple */
						node->mj_JoinState = EXEC_MJ_SKIPOUTER_ADVANCE;
						break;
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_outer subplan\n");
#endif
						/* No more outer tuples */
						MJ_printf("ExecMergeJoin: end of outer subplan\n");
						innerTupleSlot = node->mj_InnerTupleSlot;
...
#if DASOM_LOG
				/* DASOM : 15th Oct, 2015*/
				fprintf(stderr, "EXEC_outer skipinner adv\n");
#endif
				...
				switch (MJEvalInnerValues(node, innerTupleSlot))
				{
...
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_inner matchable\n");
#endif
						node->mj_JoinState = EXEC_MJ_SKIP_TEST;
						break;
					case MJEVAL_NONMATCHABLE:
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_inner unmatchable\n");
#endif
					...
					case MJEVAL_ENDOFJOIN:
#if DASOM_LOG
						/* DASOM : 15th Oct, 2015*/
						fprintf(stderr, "EXEC_inner end of inner subplan\n");
#endif
						/* No more inner tuples */
						...
						if (doFillOuter && !TupIsNull(outerTupleSlot))
						{
							 ...
							 */
#if DASOM_LOG
							fprintf(stderr, "left_join tuples for remaining outer tuple");
#endif
							node->mj_JoinState = EXEC_MJ_ENDINNER;
							break;
						}
...
#if DASOM_LOG
				/* DASOM : 15th Oct, 2015*/
				fprintf(stderr, "EXEC_outer endouter\n");
#endif
...
#if DASOM_LOG
					/* DASOM : 15th Oct, 2015*/
					fprintf(stderr, "EXEC_outer innertupleslot-null\n");
#endif
					MJ_printf("ExecMergeJoin: end of inner subplan\n");
					return NULL;
				}
...
#if DASOM_LOG
				/* DASOM : 15th Oct, 2015*/
				fprintf(stderr, "EXEC_outer endinner\n");
#endif
...
#if DASOM_LOG
					/* DASOM : 15th Oct, 2015*/
					fprintf(stderr, "EXEC_outer endouter subplan\n");
#endif
					MJ_printf("ExecMergeJoin: end of outer subplan\n");
					return NULL;
				}
