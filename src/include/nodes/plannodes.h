...
/* DASOM : It has been move from execnodes.h to plannodes.h, 16th Oct 2015*/
...
typedef struct IndexScan
{
	...
	/*
	 * DASOM 8th Oct, 2015
	 * Add new var for fidx
	 */
	int numtid;
	ItemPointerData  *_tidListptr;
	
	/*DASOM : for flash-idx ; Move them from IndexScanState to IndexScan*/
