...
extern void ReadBufferMultiple2(Relation reln, Buffer *mbuf, int mbufNum, BlockNumber *blk);
extern void ReadBufferExtendedMultiple2(Relation reln, ForkNumber forkNum, Buffer *mbuf,
		int mbufNum, BlockNumber *blk, ReadBufferMode mode, BufferAccessStrategy strategy);
extern void ReadBufferMultiple_common2(SMgrRelation smgr, char relpersistence, ForkNumber forkNum, 
		BlockNumber *blkNum, int mbufNum, Buffer *mbuf, ReadBufferMode mode, BufferAccessStrategy strategy, bool *hit);
